        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-1">
            <Link to="/" className="group inline-flex items-center">
              <span className="text-3xl mr-2 transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">🚀</span>
              <span className="text-xl logo-text">
                Tech IQ
              </span>
            </Link>
            <p className="mt-4 text-sm text-gray-300 leading-relaxed">
              Empowering developers to make informed technology choices for their projects with AI-powered recommendations.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Tech IQ. All rights reserved.
            </p>
